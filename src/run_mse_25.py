...
if __name__ == '__main__':
    ...
    for i in [1,5, 10,15,20,25]:
        ...
        # Save MSE to file
        mse_file_path = "/home/chopra/lab-git/MedImSeg-Lab24/results/MSE/mse_values_centroids_25.txt"
        ...
        results_file = "/home/chopra/lab-git/MedImSeg-Lab24/results/MSE/results_test_32_100_unifrom_centroids_5_25.txt"
        if i == 1:
